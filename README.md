...
- `date`: debe existir y tener el formato `yyyy-mm-dd`, sino generar el error `movie date is required and should be in yyyy-mm-dd format.`, con `status code` 400 y pasarle el objeto `err` a `next`.
